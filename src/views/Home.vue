    ...
    <div class="pt-24 pb-8">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          <p class="uppercase tracking-loose w-full">Quelle carte à quel prix ?</p>
          <h1 class="text-5xl font-bold leading-tight mt-4">
            La plateforme pour les acheteurs de cartes pokémon
          </h1>
          <div class="relative text-gray-600 my-10">
            <input type="search" class="bg-white h-10 px-5 pr-10 rounded-full text-sm focus:outline-none" placeholder="Search by name...">
