        ...
        <nav id="header" class="fixed w-full z-30 top-0 text-black">
            <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
                <div class="pl-4 flex items-center">
                    <router-link to="/" class="flex items-center toggleColour text-white no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="#">
                ...
                <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
                    <ul class="list-reset lg:flex justify-end flex-1 items-center">
                        ...
                        <li class="lg:mr-3" @click="onChangeDarkMode" @mouseover="onHoverDarkMode(true)" @mouseleave="onHoverDarkMode(false)">
                            <a class="cursor-pointer py-2 px-4">
                                <svg v-show="!$store.state.darkMode" class="h-6 w-6 mx-4" xmlns="http://www.w3.org/2000/svg" :fill="(isDarkModeHover) ? colorIconDarkMode : 'none'" viewBox="0 0 24 24" :stroke="colorIconDarkMode">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
                                </svg>
                                <svg v-show="$store.state.darkMode" class="h-6 w-6 mx-4" xmlns="http://www.w3.org/2000/svg" :fill="(isDarkModeHover) ? 'white' : 'none'" viewBox="0 0 24 24" stroke="white">
